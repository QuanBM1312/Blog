...
type Tab = 'cau-chuyen' | 'triet-ly'

export default function VeChungToiPage() {
  const [activeTab, setActiveTab] = useState<Tab>('cau-chuyen')
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background">
        ...
        {/* Tab Navigation */}
        <section className="sticky top-[76px] xl:top-[92px] z-40 bg-background border-b border-primary/10">
          <div className="max-w-3xl mx-auto px-6 flex">
            <button
              onClick={() => setActiveTab('cau-chuyen')}
              className={`flex-1 py-5 font-montserrat text-sm font-bold tracking-[0.15em] uppercase text-center border-b-2 transition-all ${
                activeTab === 'cau-chuyen'
