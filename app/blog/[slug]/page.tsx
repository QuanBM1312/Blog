...
export default async function BlogPostPage({ params }: BlogPostProps) {
  ...
  const defaultCategory = { id: '', name: 'Sức khỏe', slug: 'hai-linh-blog', template_type: 'standard' as const }
  ...
  const renderLayout = () => {
    switch (cat.template_type) {
      case "herb_dictionary":
        return <HerbLayout post={post} category={cat} basePath="/blog" />
      case "storytelling":
        return <StorytellingLayout post={post} category={cat} basePath="/blog" />
      case "standard":
      default:
        return <StandardLayout post={post} category={cat} basePath="/blog" />
    }
  }
